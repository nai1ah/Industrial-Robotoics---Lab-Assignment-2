...
%% CreateModel
        function CreateModel(self)
            ...
            link(3) = Link('d',-0.04,'a',0.405,'alpha',0,'qlim', [-pi pi], 'offset', 0);
            link(4) = Link('d',-0.01,'a',0.42,'alpha',0,'qlim',[-pi pi],'offset', 0);
            link(5) = Link('d',0.09,'a',0,'alpha',-pi/2,'qlim',[-pi pi], 'offset',0);
            link(6) = Link('d',	0.155,'a',0,'alpha',0,'qlim',[-pi pi], 'offset', 0);
